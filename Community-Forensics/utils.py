...
def get_dataloader(args, mode="train"):
    if args.dataset == 'cifake':
        data_dir = args.dataset_path if mode == 'train' else args.val_path
        ...
        sampler = DistributedSampler(dataset, shuffle=True) if args.gpus > 1 else None
